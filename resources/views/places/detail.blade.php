...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
             <div class="card">
                <div class="card-header text-white"style="background-color: #ADD8E6;"">Detail Tempat</div>
                <div class="card-body style="background-color: #ADD8E6;"">
                    <table class="table">
                        <tbody>
                            ...
                            <tr><td>Deksripsi</td><td>{{ $place->description }}</td></tr>
                        </tbody>
        ...
        <div class="col-md-6">
            <div class="card" style="background-color: #ADD8E6;">
                <div class="card-header text-white font-bold">Detail Map</div>
